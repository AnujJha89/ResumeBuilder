...
{
    /// <inheritdoc />
    public partial class AddIdentityAndResumeTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LaTeXCodeTemplate = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CredentialUrl = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoardOrUniversity = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    PassingYear = table.Column<int>(type: "int", nullable: false),
                    PercentageOrCGPA = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TechnologiesUsed = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    GitHubLink = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillCategory = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
